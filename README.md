...
* Create an environment and pass in MongoDB URI, App ID, and Master Key: `eb create --envvars DATABASE_URI=mongodb://172.25.0.0/16:8103/parse,APP_ID=B1mjT61ZMr,MASTER_KEY=12345`
